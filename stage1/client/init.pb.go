...
func _Kurma_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error) (interface{}, error) {
...
func _Kurma_Destroy_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error) (interface{}, error) {
...
func _Kurma_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error) (interface{}, error) {
	in := new(None)
	if err := dec(in); err != nil {
		return nil, err
	}
...
func _Kurma_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error) (interface{}, error) {
	in := new(ContainerRequest)
	if err := dec(in); err != nil {
		return nil, err
	}

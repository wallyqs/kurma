...
import (
	...
	"github.com/apcera/util/tarhelper/Godeps/_workspace/src/github.com/apcera/logray"
	"github.com/apcera/util/tarhelper/Godeps/_workspace/src/github.com/apcera/logray/unittest"
)

func Example() {

	buffer := unittest.SetupBuffer( // Setup
	)

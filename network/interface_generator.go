...
func (d *networkDriver) generateInterfaceName(pod stage1.Pod, interfaces []*types.IPResult) (string, error) {
...
func funcsForPod(container stage1.Pod, interfaces []*types.IPResult) template.FuncMap {

...
yum -y install gcc make automake autoconf readline-devel zlib-devel openssl openssl-devel libffi-devel readline-devel zlib-devel gdbm-devel ncurses-devel gcc

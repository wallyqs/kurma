...
func New(options *Options) (stage1.ImageManager, error) {
	m := &Manager{
		log:     options.Log,
		Options: options,
	}
...
func (m *Manager) ResolveTree(hash string) (*stage1.ResolutionTree, error) {
	// resolve the tree
	...
	return &stage1.ResolutionTree{Order: layers, Paths: paths, Manifests: manifests}, nil
}
